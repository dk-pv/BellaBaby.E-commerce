...
//   if (loading) {
//     return <p className="text-gray-600 text-center">Loading customer details...</p>;
//   }

//   return (
//     <div className="p-8 bg-gradient-to-r from-green-50 to-lime-100 rounded-3xl shadow-xl">
...
//           ← Back
//         </button>
//         <h2 className="flex-grow text-4xl font-bold text-green-700 text-center">
//           Customers Details
//         </h2>
//       </div>
...
//                   <td className="border p-4">{user.name || "N/A"}</td>
//                   <td className="border p-4">{user.email || "N/A"}</td>
//                   <td className="border p-4">{user.role || "N/A"}</td>
//                   <td className="border p-4">{user.createDate || "N/A"}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
