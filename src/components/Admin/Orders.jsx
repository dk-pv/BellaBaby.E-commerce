...
//   if (loading) {
//     return <p className="text-gray-600 text-center">Loading order details...</p>;
//   }

//   return (
//     <div className="p-8 bg-gradient-to-r from-yellow-50 to-orange-100 rounded-3xl shadow-xl">
...
//           Back
//         </button>
//         <h2 className="flex-grow text-4xl font-bold text-orange-700 text-center">
//           Order Details
//         </h2>
//       </div>
...
//                 <th className="border p-4">Produt Price</th>
...
//                   <td className="border p-4">₹{order.totalAmount || "N/A"}</td>
//                   <td className="border p-4">{order.date || "N/A"}</td>
//                   <td className="border p-4">{order.paymentMethod || "N/A"}</td>
//                   <td className="border p-4">{order.quantities || "N/A"}</td>
//                   <td className="border p-4">{order.customer.name || "N/A"}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
