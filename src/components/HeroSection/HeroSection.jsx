...
//         />
//       </div>
//       <div className="relative z-10 flex flex-col justify-center items-start h-full p-6 md:p-12">
//         <h1 
//           className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#FF6B6B] drop-shadow-xl animate-fade-in">
//           Bella<span className="text-[#1E3A8A]">Baby</span>
//         </h1>
//         <p 
//           className="mt-4 text-lg md:text-2xl lg:text-3xl text-white max-w-2xl leading-relaxed drop-shadow-lg">
//           "Wrap your little one in comfort and care. Explore our handcrafted, safe, and delightful baby essentials."
//         </p>
//         <button 
//           className="mt-6 px-6 py-3 bg-[#FF6B6B] text-white font-bold rounded-full hover:bg-[#FF4757] transition">
//           Shop Now
//         </button>
//       </div>
//     </section>
